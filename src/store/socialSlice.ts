...
const FALLBACK_LEADERBOARD: LeaderboardUser[] = [
  { username: "???", className: "Маг", classEmoji: "🧙‍♂️", avatar: "mage", level: 12, xp: 12500, totalQuestsCompleted: 87, streakDays: 14 },
  { username: "???", className: "Целитель", classEmoji: "💖", avatar: "cleric", level: 11, xp: 11200, totalQuestsCompleted: 72, streakDays: 10 },
  { username: "???", className: "Воин", classEmoji: "⚔️", avatar: "warrior", level: 10, xp: 10500, totalQuestsCompleted: 65, streakDays: 8 },
];
